...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "Email",
      href: "mailto:dotrungkien.kien@gmail.com",
      icon: (
    ...
    {
      name: "Facebook",
      href: "https://facebook.com/kido.kien07",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      color: "hover:text-blue-600 hover:border-blue-500",
    },
    {
      name: "GitHub",
      href: "https://github.com/dtkien205",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
      name: "Instagram",
      href: "https://instagram.com/_kido.07",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  return (
    <footer className="relative mt-16 bg-gray-50 border-t border-gray-200">
      {/* Decorative top line */}
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 py-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <h3 className="font-extrabold text-2xl text-blue-600">
                Kido
              </h3>
            </div>
            {/* Stats */}
            <div className="flex gap-4 pt-2">
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-gray-500">CTF Writeups</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((social) => (
              <a
                ...
                className={`group relative inline-flex items-center justify-center w-11 h-11 rounded-xl bg-white border-2 border-gray-200 text-gray-600 shadow-sm hover:shadow-md transition-all ${social.color}`}
              >
                {social.icon}
